...
#define _nstates10	14	/* lofree */
#define minseq10	200
#define maxseq10	212
#define _endstate10	13

#define _nstates9	21	/* proc9 */
#define minseq9	180
#define maxseq9	199
#define _endstate9	20

#define _nstates8	21	/* proc8 */
#define minseq8	160
#define maxseq8	179
#define _endstate8	20

#define _nstates7	21	/* proc7 */
#define minseq7	140
#define maxseq7	159
#define _endstate7	20

#define _nstates6	21	/* proc6 */
#define minseq6	120
#define maxseq6	139
#define _endstate6	20

#define _nstates5	21	/* proc5 */
#define minseq5	100
#define maxseq5	119
#define _endstate5	20

#define _nstates4	21	/* proc4 */
#define minseq4	80
#define maxseq4	99
#define _endstate4	20

#define _nstates3	21	/* proc3 */
#define minseq3	60
#define maxseq3	79
#define _endstate3	20

#define _nstates2	21	/* proc2 */
#define minseq2	40
#define maxseq2	59
#define _endstate2	20

#define _nstates1	21	/* proc1 */
#define minseq1	20
#define maxseq1	39
#define _endstate1	20

#define _nstates0	21	/* proc0 */
#define minseq0	0
#define maxseq0	19
...
#define Pproc9	((P9 *)_this)
typedef struct P9 { /* proc9 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc8	((P8 *)_this)
typedef struct P8 { /* proc8 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc7	((P7 *)_this)
typedef struct P7 { /* proc7 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc6	((P6 *)_this)
typedef struct P6 { /* proc6 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc5	((P5 *)_this)
typedef struct P5 { /* proc5 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc4	((P4 *)_this)
typedef struct P4 { /* proc4 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc3	((P3 *)_this)
typedef struct P3 { /* proc3 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc2	((P2 *)_this)
typedef struct P2 { /* proc2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc1	((P1 *)_this)
typedef struct P1 { /* proc1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pproc0	((P0 *)_this)
typedef struct P0 { /* proc0 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
